...
/**
 * ForeignKey constraints를 갖는 SecondaryDatabase를 조회하기 위한 IFreingKeySecondaryQuery 구현체.
 * ForeignKeySecondaryQuery를 생성하는 가장 쉬운 방법은 QueryBuilder.class를 사용하는 것입니다.
 */
public class ForeignKeySecondaryQuery implements IForeignKeySecondaryQuery {
    ...
    public ForeignKeySecondaryQuery(String dbName, Class keyClass, Class valueBaseClass, boolean writeAllowed, String primaryDbName, String keyName, String foreignKeyDbName) {
        this.dbName = dbName;
    ...
    public boolean isValid() {
        return NullChecker.check(this.dbName, this.keyClass, this.valueBaseClass, this.primaryDbName, this.keyName, this.foreignKeyDbName);
    }

    @Override
    public String toString() {
        return "ForeignKeySecondaryQuery{" +
                "dbName='" + dbName + '\'' +
                ", keyClass=" + keyClass +
